...
| Native OS/architecture | Declared v1 release targets: `linux/amd64`, `linux/arm64` | The release snapshot and complete local validation build exactly these targets. macOS, Windows, and all unlisted combinations are unsupported and receive no v1 release artifacts. |
